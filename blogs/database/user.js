...
db.prepare(`CREATE TABLE IF NOT EXISTS users (
    id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, email TEXT, password TEXT)`).run();
    ...
    export const deleteUser=(id)=> db.prepare('DELETE user FROM users WHERE id=?').run(id);